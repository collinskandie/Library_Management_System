# Generated by Django 3.0 on 2019-12-18 21:30
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('catalogg', '0006_auto_20191219_0019'),
    ]
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='bookinstance',
            options={'ordering': ['date_due_back'], 'permissions': (('can_mark_returned', 'Set book as returned'),)},
        ),
        ...
        migrations.AlterField(
            model_name='bookinstance',
            name='book',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='catalogg.Book'),
        ),
        migrations.AlterField(
            model_name='bookinstance',
            name='id',
        ...
        migrations.AddField(
            model_name='book',
            name='language',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='catalogg.Language'),
        ),
    ]
